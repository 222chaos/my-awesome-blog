...
def main():
    ...
    try:
        ...
        article_images = [
            {
                ...
                "image_url": "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&h=400&fit=crop&q=85"
            },
            {
                "title": "React Server Components深度解析",
                "slug": "react-server-components-deep-dive",
                "image_url": "https://images.unsplash.com/photo-1558655146-d0978d910a3?w=800&h=400&fit=crop&q=85"
            },
            {
                "title": "PostgreSQL全文搜索实战",
                "slug": "postgresql-fulltext-search",
                "image_url": "https://images.unsplash.com/photo-1544383882-7c9e8c7192ea?w=800&h=400&fit=crop&q=85"
            },
            {
                "title": "Docker多阶段构建优化镜像",
                "slug": "docker-multi-stage-build-optimization",
                "image_url": "https://images.unsplash.com/photo-1605745341112-85936b00f2d9?w=800&h=400&fit=crop&q=85"
            },
            {
                "title": "AI大模型应用开发实战",
                "slug": "ai-llm-application-development",
                "image_url": "https://images.unsplash.com/photo-1677442136019-21780ecad9956?w=800&h=400&fit=crop&q=85"
            },
            {
                "title": "TypeScript高级类型编程",
                "slug": "typescript-advanced-type-programming",
                "image_url": "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&h=400&fit=crop&q=85"
            }
        ]
        ...
        for article in articles:
            ...
            if not img_data:
                print(f"✗ 未找到匹配的图片: {article.get('title', 'Unknown')}")
                failed_count += 1
                continue
