  ...
  return (
    <div
      ...
      className={cn(
        ...
        "glass-morphism border border-glass-border bg-glass/95 backdrop-blur-xl text-gray-100 shadow-lg",
        className
      )}
      {...props}
    />
...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-glass/30 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-glass/50 hover:text-tech-cyan focus:bg-glass/50 focus:text-tech-cyan focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-glass/50 data-[state=open]:bg-glass/50 backdrop-blur-lg"
);

const navigationMenuLinkStyle = cva(
  "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-glass/50 hover:text-tech-cyan focus:bg-glass/50 focus:text-tech-cyan data-[active]:bg-glass/50"
);
